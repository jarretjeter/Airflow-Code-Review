...
# Change path to location that you downloaded this project to
...
# To change change user and password for the GUI, in your terminal enter, "airflow users  create --role Admin --username [your user name] --email [your email] --firstname [first name] --lastname [last name] --password [your password]"
